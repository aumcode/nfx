...
//============================================================================================
        ...
        [TestCase]
        public void CompositeShardingID_2()
        {
          var id1 = new CompositeShardingID(1,new GDID(0,123));
          var id2 = new CompositeShardingID(1,new GDID(0,123));
        ...
        [TestCase]
        public void CompositeShardingID_4()
        {
          var id1 = new CompositeShardingID(1,23,11);
          var id2 = new CompositeShardingID(1,23,11);
