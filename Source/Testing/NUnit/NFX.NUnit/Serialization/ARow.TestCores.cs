...
namespace NFX.NUnit.Serialization.Arow
{
  ...
  ///<summary>
  /// ITypeSerializationCore for NFX.NUnit.Serialization.Ver1Row
  ///</summary>
  internal class Ver1Row_arow_core : NFX.Serialization.Arow.ITypeSerializationCore
  {
    void ITypeSerializationCore.Register()
    {
       ArowSerializer.Register(typeof(NFX.NUnit.Serialization.Ver1Row), this);
    }

    void ITypeSerializationCore.Serialize(TypedRow aRow, WritingStreamer streamer)
    {
      var row = (NFX.NUnit.Serialization.Ver1Row)aRow;
      // 'a' = 97
      if (row.A != null)
    ...
    void ITypeSerializationCore.Deserialize(TypedRow aRow, ReadingStreamer streamer)
    {
      ...
      while(true)
      {
         ...
         continue;
           ...
           atp = Reader.ReadDataType(streamer);
           if (atp!=DataType.Row) break;
           row.G = Reader.ReadRowList<NFX.NUnit.Serialization.Ver1Row>(row, streamer, CodeGenerator.GetName(name));
           continue;
                     }
         }
         Reader.ConsumeUnmatched(row, streamer, CodeGenerator.GetName(name), dt, atp);
  ...
  ///<summary>
  /// ITypeSerializationCore for NFX.NUnit.Serialization.Ver2Row
  ///</summary>
  internal class Ver2Row_arow_core : NFX.Serialization.Arow.ITypeSerializationCore
  {
    void ITypeSerializationCore.Register()
    {
       ArowSerializer.Register(typeof(NFX.NUnit.Serialization.Ver2Row), this);
    }

    void ITypeSerializationCore.Serialize(TypedRow aRow, WritingStreamer streamer)
    {
      var row = (NFX.NUnit.Serialization.Ver2Row)aRow;
      // 'a' = 97
      if (row.A != null)
      AW.Write(streamer, 97, row.A);
      else AW.WriteNull(streamer, 97);
    ...
    void ITypeSerializationCore.Deserialize(TypedRow aRow, ReadingStreamer streamer)
    {
      ...
      while(true)
      {
         ...
         switch(name)
         {
           ...
           atp = Reader.ReadDataType(streamer);
           if (atp!=DataType.Row) break;
           row.G = Reader.ReadRowList<NFX.NUnit.Serialization.Ver2Row>(row, streamer, CodeGenerator.GetName(name));
           continue;
                     }
         }
         Reader.ConsumeUnmatched(row, streamer, CodeGenerator.GetName(name), dt, atp);
