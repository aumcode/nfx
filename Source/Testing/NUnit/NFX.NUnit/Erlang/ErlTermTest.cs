...
namespace NFX.NUnit.Erlang
{
    ...
    public class ErlTermFixture
    {
        ...
        public void ErlLongTest()
        {
            ...
            Assert.AreEqual(10, t.ValueAsLong);
            Assert.AreEqual(10, t.ValueAsDecimal);
            Assert.AreEqual(new DateTime(1970, 1, 1, 0, 0, 10, 0), t.ValueAsDateTime);
        ...
        public void ErlPidTest()
        {
            ...
            Assert.AreEqual("#Pid<test.10.3>", t.ToString());
            Assert.AreEqual("#Pid<test.10.3>", t.ValueAsString);
            Assert.IsTrue(t.IsScalar);
        ...
        public void ErlRefTest()
        {
            ...
            Assert.AreEqual("#Ref<test.5.6.7>", t.ToString());
            Assert.AreEqual("#Ref<test.5.6.7>", t.ValueAsString);
            Assert.IsTrue(t.IsScalar);
